...
class AllBlockedSellersScreen extends StatefulWidget {
  ...
  @override
  State<AllBlockedSellersScreen> createState() => _AllBlockedSellersScreen();
}

class _AllBlockedSellersScreen extends State<AllBlockedSellersScreen> {
  ...
  Widget build(BuildContext context)
  {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: ()
                      {
                        displayDialogBoxForBlockingAccount(allRestaurants!.docs[i].id);
                      },
                    ),
                  ),
                ],
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          "  All Blocked Restaurants Account  ",
          style: TextStyle(
            fontSize: 30,
            letterSpacing: 3,
            color: Colors.white,
